...
public final class OrderEndpoint_MyOrderPort_Client {
    ...
    public static void main(String args[]) throws java.lang.Exception {
        ...
        System.out.println("THe OrderEndpoint port impl on "
        		+ "client side is "+port.getClass().getName());
        String orderstatus = port.order("Auto Part", 1000, "Bombay-Services");
        System.out.println("First order.result=" + orderstatus);
        
        {
        System.out.println("Invoking order...");
        java.lang.String orderName = "My Biz Order";
        int num = 1245;
        java.lang.String name = "Vijay Industries";
        java.lang.String _order__return =
port.order(orderName, num, name);
        System.out.println("second order.result=" + _order__return);
